...
from composer.constants import INGESTION_TEMP_DIR, DEFAULT_CLEANUP_DAYS


class Command(BaseCommand):
    help = "Cleans up old temporary ingestion files"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"Cleaning up temporary files older than {days} days...")
        ...
        # Only clean the temporary directory (log files in INGESTION_BASE_DIR are persistent)
        directory = INGESTION_TEMP_DIR
