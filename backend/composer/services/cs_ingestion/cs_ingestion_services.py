...
from composer.services.cs_ingestion.helpers.overwritable_helper import get_overwritable_and_new_statements
...
def ingest_statements(update_upstream=False, update_anatomical_entities=False, disable_overwrite=False, full_imports=[], label_imports=[]):
    ...
    overridable_and_new_statements = get_overwritable_and_new_statements(statements_list, disable_overwrite)
    statements = validate_statements(overridable_and_new_statements, update_anatomical_entities)
