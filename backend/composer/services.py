class ConnectivityStatementService:
    
    def __init__(self, connectivity_statement):
        self.connectivity_statement = connectivity_statement
    ...
    def do_transition(self, transition, user=None, request=None):
        ...
        trans_func = getattr(self.connectivity_statement, transition, None)
        ...
        return self.connectivity_statement
