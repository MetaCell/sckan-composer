...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('Axon sensory ending', 'Axon Se'), ('Axon terminal', 'Axon T'), ('Axon sensory terminal', 'Axon St')], default='Axon sensory ending', max_length=25, null=True),
        ),
        migrations.AlterField(
            model_name='note',
            name='connectivity_statement',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notes', to='composer.connectivitystatement', verbose_name='Connectivity Statement'),
        ),
        migrations.AlterField(
            model_name='note',
            name='provenance',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='notes', to='composer.provenance', verbose_name='Provenance'),
        ),
        migrations.AlterField(
            model_name='provenance',
            name='circuit_type',
        ...
        migrations.AlterField(
            model_name='via',
            name='connectivity_statement',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='path_set', to='composer.connectivitystatement', verbose_name='Connectivity Statement'),
        ),
