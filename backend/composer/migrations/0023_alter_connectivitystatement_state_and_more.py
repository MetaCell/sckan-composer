...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='connectivitystatement',
            constraint=models.CheckConstraint(check=models.Q(('state__in', ['draft', 'compose_now', 'curated', 'excluded', 'reviewed', 'connection_missing', 'npo_approved', 'approved'])), name='state_valid'),
        ),
    ]
