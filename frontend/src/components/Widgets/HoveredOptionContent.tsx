...
export const CustomFooter = ({entity}: any) => {
    const ontologyUrlDetail = entity.content.find((detail: OptionDetail) => detail.title === DROPDOWN_MAPPER_ONTOLOGY_URL);
    const ontologyUrl = ontologyUrlDetail ? ontologyUrlDetail.value : 'URL not available';
